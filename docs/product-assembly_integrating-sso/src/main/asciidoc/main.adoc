...
include::product-administration-and-configuration-guide/sso-client-adapter-proc.adoc[leveloffset=+1]

include::product-administration-and-configuration-guide/sso-central-proc.adoc[leveloffset=+1]

include::product-administration-and-configuration-guide/sso-central-configure-proc.adoc[leveloffset=+2]
