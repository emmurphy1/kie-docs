...
----
ifdef::PAM[]
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-{URL_COMPONENT_CENTRAL}-standalone.jar -s application-config.yaml
endif::PAM[]
ifdef::DM[]
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION_LONG}.GA-{URL_COMPONENT_CENTRAL}-standalone.jar -s application-config.yaml
endif::DM[]
----
+
...
---- 
ifdef::PAM[]
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-{URL_COMPONENT_CENTRAL}-standalone.jar -s application-config.yaml -D<property>=<value> -D<property>=<value>
endif::PAM[]
ifdef::DM[]
java -jar {PRODUCT_INIT}-{PRODUCT_VERSION_LONG}.GA-{URL_COMPONENT_CENTRAL}-standalone.jar -s application-config.yaml -D<property>=<value> -D<property>=<value>
endif::DM[]
...
//[source]
//----
//java -jar {PRODUCT_INIT}-{PRODUCT_VERSION_LONG}.GA-{URL_COMPONENT_CENTRAL}-standalone.jar \
