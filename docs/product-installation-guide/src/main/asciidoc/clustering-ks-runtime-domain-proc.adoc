...
.. Navigate to the `TEMP_DIR_/{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-kie-server-ee7/kie-server.war` directory.
.. Select the contents of the  `_TEMP_DIR_/{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-kie-server-ee7/kie-server.war` directory and create the `kie-server.zip` file.
...
.. Navigate to the `__TEMP_DIR__/{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}.GA-kie-server-ee7/SecurityPolicy/`
directory.
.. Select the contents of the  `__TEMP_DIR__/{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}.GA-kie-server-ee7/SecurityPolicy/` directory and create the `SecurityPolicy.zip` file.
