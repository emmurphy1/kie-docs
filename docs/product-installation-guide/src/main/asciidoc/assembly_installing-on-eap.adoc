...
For information on how to install {EAP} 7.0.8 on your computer, see the _https://access.redhat.com/documentation/en-us/red_hat_jboss_enterprise_application_platform/7.0/html-single/installation_guide/[{EAP} Installation Guide]_.
