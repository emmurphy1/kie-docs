...
. If you want to use a security manager with {KIE_SERVER}, copy the contents of the `__TEMP_DIR__/{PRODUCT_INIT}-{PRODUCT_VERSION_LONG}-kie-server-ee7/SecurityPolicy`
