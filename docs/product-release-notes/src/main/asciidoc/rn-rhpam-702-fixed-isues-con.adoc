...
* SME clarification. [https://issues.jboss.org/browse/RHPAM-1077[RHPAM-1077]]
...
* The `WorkflowRuntimeException` wraps only the bottom root cause Exception in `RuleSetNodeInstance`. [https://issues.jboss.org/browse/RHPAM-1198[RHPAM-1189]]
