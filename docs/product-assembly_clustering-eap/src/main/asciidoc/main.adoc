...
include::product-installation-guide/clustering-create-dev-proc.adoc[leveloffset=+2]
...
include::product-installation-guide/clustering-headless-controller-proc.adoc[leveloffset=+1]

== Installing and configuring SmartRouter
