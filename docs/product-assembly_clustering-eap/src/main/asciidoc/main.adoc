...
* You have reviewed the information in {URL_PLANNING_INSTALL}[_{PLANNING_INSTALL}_].
* A {EAP} 7.1 cluster is available. For information, see the https://access.redhat.com/documentation/en-us/reference_architectures/2017/html-single/configuring_a_red_hat_jboss_eap_7_cluster/[_Configuring a {EAP} 7 Cluster_].
