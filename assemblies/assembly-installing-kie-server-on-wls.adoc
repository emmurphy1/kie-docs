...
.Prerequisites
* An {WEBLOGIC} instance version 12.2.1.3.0 or later is installed.
// Is 'or later' correct? WLS is up to 14.1.1.0.

For complete installation instructions, see the http://www.oracle.com/technetwork/middleware/weblogic/documentation/index.html[{WEBLOGIC} product page].
